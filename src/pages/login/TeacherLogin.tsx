...
const TeacherLogin: React.FC = () => {
    ...
    return (
        <PageLayout title="loginTeacherTitle" subtitle="loginTeacherSubtitle">
            <div className="max-w-6xl mx-auto">
                <div className="grid md:grid-cols-2 gap-8 items-center">
                    {/* Left Side - Image & Welcome */}
                    <div className="relative rounded-2xl overflow-hidden shadow-2xl">
                        <div className="aspect-[4/5] relative">
                            <img src={quranImage} alt="Teachers" className="w-full h-full object-cover" />
                            <div className="absolute inset-0 bg-gradient-to-t from-primary/90 via-primary/60 to-transparent flex items-end p-8">
                                <div className="text-white">
                                    <h2 className="text-3xl font-bold mb-3">Teacher Dashboard</h2>
                                    <p className="text-lg opacity-90">{t("loginTeacherWelcome")}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="bg-card rounded-2xl p-8 shadow-xl border border-border">
                        <div className="mb-8 text-center">
                            ...
                            <h3 className="text-2xl font-bold text-foreground mb-2">{t("loginTeacherTitle")}</h3>
                            <p className="text-muted-foreground">{t("loginTeacherSubtitle")}</p>
                        </div>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="pt-4 text-center border-t border-border">
                                <p className="text-sm text-muted-foreground">
                                    Need help? <a href="#" className="text-primary hover:text-primary-dark font-medium">Contact Admin</a>
                                </p>
                            </div>
                        </form>
                    </div>
