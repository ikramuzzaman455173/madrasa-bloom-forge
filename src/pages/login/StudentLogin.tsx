...
const StudentLogin: React.FC = () => {
    ...
    return (
        <PageLayout title="loginStudentTitle" subtitle="loginStudentSubtitle">
            <div className="max-w-6xl mx-auto">
                <div className="grid md:grid-cols-2 gap-8 items-center">
                    {/* Left Side - Image & Welcome */}
                    <div className="relative rounded-2xl overflow-hidden shadow-2xl">
                        <div className="aspect-[4/5] relative">
                            <img src={studentsImage} alt="Students" className="w-full h-full object-cover" />
                            <div className="absolute inset-0 bg-gradient-to-t from-primary/90 via-primary/60 to-transparent flex items-end p-8">
                                <div className="text-white">
                                    ...
                                    <p className="text-lg opacity-90">{t("loginStudentWelcome")}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="bg-card rounded-2xl p-8 shadow-xl border border-border">
                        <div className="mb-8 text-center">
                            ...
                            <h3 className="text-2xl font-bold text-foreground mb-2">{t("loginStudentTitle")}</h3>
                            <p className="text-muted-foreground">{t("loginStudentSubtitle")}</p>
                        </div>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="pt-4 text-center border-t border-border">
                                <p className="text-sm text-muted-foreground">
                                    New student? <a href="#" className="text-primary hover:text-primary-dark font-medium">Register here</a>
                                </p>
                            </div>
                        </form>
                    </div>
